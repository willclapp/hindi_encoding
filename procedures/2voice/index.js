...
let irb = {
    ...
    stimulus: '<div class ="irb"><img src="../../imgs/SUSig_2color_Stree_Stacked_Left.png" alt="Stanford University Logo" class="logo"><p id="legal"><font size="3">हम आपको भाषा उत्पादन और उसके आंकलन पर एक शोध के अध्ययन में भाग लेने के लिए आमंत्रित करते हैं।<br><br>आपका प्रयोगकर्ता आपसे भाषा पर चर्चा करने के लिए कहेगा जैसे वाक्य या शब्द पढ़ना, चित्रों का नामकरण करना या दृश्यों का वर्णन करना, अपने स्वयं के वाक्य बनाना, या भाषा के एक सरल खेल में भाग लेना।<br><br>इस अध्ययन में शामिल होने पर आपको किसी भी प्रकार का कोई जोखिम या लाभ नहीं है।<br><br>यदि आपने इस फॉर्म को पढ़ लिया है और इस प्रयोग में भाग लेने का फैसला किया है, तो कृपया समझें कि आपकी भागीदारी स्वैच्छिक है और आपको किसी भी समय बिना किसी दंड के भागीदारी या लाभों के नुकसान जिससे आप हकदार हैं, अपनी सहमति वापस लेने या बंद करने का अधिकार है। आपको विशेष कार्यों को करने से मना करने का अधिकार है। अध्ययन के परिणामस्वरूप, सभी प्रकाशित और लिखित तथ्य में आपकी व्यक्तिगत गोपनीयता को बनाए रखा जाएगा। आपके रिकॉर्ड के लिए यह फॉर्म आप प्रिंट कर सकते हैं |<br><br>संपर्क जानकारी:<br>यदि इस शोध अध्ययन या इसकी प्रक्रियाओं,जोखिम और लाभ के बारे में आपका कोई प्रश्न, चिंता या शिकायत है तो आपको प्रोटोकॉल निदेशक मेघन सुमनेर से (650) 725-9336 पर संपर्क करना चाहिए।<br><br>यदि आप इस अध्ययन के संचालन से संतुष्ट नहीं हैं या आपको अनुसंधान के भागीदार के रूप में आपके अधिकारों के बारे में कोई चिंता, शिकायत या सामान्य प्रश्न हैं तो कृपया स्टैनफोर्ड इंस्टीट्यूशनल रिव्यू बोर्ड (आईआरबी) अनुसंधान दल के कुछ स्वतंत्र लोगों से बात करने के लिए अनुसंधान दल (650) 723-2480 पर या 1-866-680-2906 पर टोल फ्री से संपर्क करें। आप स्टैनफोर्ड आईआरबी, स्टैनफोर्ड यूनिवर्सिटी, 3000 एल कैमिनो रियल, फाइव पालो ऑल्टो स्क्वायर, चौथी मंजिल, पालो ऑल्टो, सीए 94306 यूएसए को भी लिख सकते<br><br>यदि आप भाग लेने के लिए सहमत हैं, तो कृपया अध्ययन कार्यों के लिए आगे बढ़ें।<br><br></font></p></div>',
    choices: ['Continue']
};
